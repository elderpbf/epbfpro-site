(function() {
  ...
  class ClasspulseQuestion extends HTMLElement {
    ...
    _renderInactivityPause() {
      this.innerHTML = '<div class="cpq-resume-overlay" role="button" tabindex="0" aria-label="Toque para continuar" style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:60vh;width:100%;cursor:pointer;user-select:none;text-align:center;padding:2rem">'
        + '<div style="font-size:1.1rem;color:var(--text-secondary,#666);margin-bottom:0.75rem">Sessão em pausa</div>'
        + '<div style="font-size:0.9rem;color:var(--text-light,#aaa)">Toque em qualquer lugar para continuar</div>'
        + '</div>';
