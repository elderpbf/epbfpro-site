...
# Cache-bust
if grep -q 'js/app.js?v=2.8' index.html; then pass "app.js bumped to v=2.8"; else die "app.js not v=2.8"; fi
...
if grep -q 'css/typedrill.css?v=2.1' index.html; then pass "typedrill.css bumped to v=2.1"; else die "typedrill.css not v=2.1"; fi
