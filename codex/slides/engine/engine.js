// slides/engine/engine.js — Codex-owned html-slides presentation engine.
//
// Lightweight, zero-dependency deck runtime (formerly classforge/html-slides/
// engine.js, the "panels-legacy" engine). Moved into Codex so the Slides feature
// is owned end-to-end and carries no dependency on classforge, which is slated
// for eventual retirement. Per manifest/ARCHITECTURE.md §10 the Slides component
// keeps its own internal namespace (`pn-` classes, `--pn-` vars); it is NOT
// rewritten to the `cdx-` convention. The only boundary Codex sees is the mount
// API (init/goTo/next/prev).
//
// Usage in a deck page: import Panels from '<path>/engine.js'; Panels.init();
