...
const pt = {
  ...
  'login.too_many_attempts': 'Muitas tentativas com este código. Peça um novo código para continuar.',
  'login.name_required':    'Escreva seu nome para continuar.',
  ...
  'entrar.code_sub':        'O código de 4 números da sua turma.',
  ...
  'entrar.offline':         'Não conseguimos verificar agora. Tente de novo em instantes.',
  ...
  // Reaction survey (track-64). Chrome only: the ten question texts are instrument DATA and live
  // in ct_survey_questions, never here.
  'survey.eyebrow':         'Avaliação do curso',
  'survey.title':           'Como foi o curso para você?',
  'survey.lede':            'São dez perguntas rápidas e suas respostas são anônimas. Elas ajudam a melhorar as próximas turmas.',
  'survey.gate_title':      'Antes de entrar na sua trilha',
  'survey.gate_lede':       'As aulas deste curso terminaram. Responda estas dez perguntas rápidas para continuar. Leva menos de dois minutos e suas respostas são anônimas.',
  'survey.missing_one':     'Falta 1 pergunta obrigatória para enviar.',
  'survey.missing_n':       'Faltam {n} perguntas obrigatórias para enviar.',
  'survey.scale_low':       'Discordo',
  'survey.scale_high':      'Concordo',
  ...
  'survey.strip_sub':       'Leva menos de dois minutos.',
  'survey.close':           'Fechar',
  'survey.thanks_title':    'Obrigado pela sua avaliação',
  'survey.thanks_lede':     'Sua resposta foi registrada de forma anônima.',
  'survey.continue':        'Continuar para a trilha',
  'survey.pres_label':      'Apresentação',
  'survey.pres_dialog':     'Janela',
  'survey.pres_full':       'Tela cheia',
  'survey.pace_label':      'Ritmo',
  'survey.pace_all':        'Tudo de uma vez',
  'survey.pace_steps':      'Uma por vez',
...
const en = {
  ...
  'login.too_many_attempts': 'Too many attempts with this code. Ask for a new one to continue.',
  'login.name_required':    'Type your name to continue.',
  'login.finish':           'Finish',
  ...
  'entrar.code_sub':        'Your class 4-digit code.',
  ...
  'entrar.offline':         "We couldn't check right now. Try again in a moment.",
  ...
  'survey.eyebrow':         'Course evaluation',
  'survey.title':           'How was the course for you?',
  'survey.lede':            'Ten quick questions, and your answers are anonymous. They help make the next cohorts better.',
  'survey.gate_title':      'Before you go into your trail',
  'survey.gate_lede':       'This course has finished. Answer these ten quick questions to carry on. It takes under two minutes and your answers are anonymous.',
  'survey.missing_one':     '1 required question left before you can send.',
  'survey.missing_n':       '{n} required questions left before you can send.',
  'survey.scale_low':       'Disagree',
  'survey.scale_high':      'Agree',
  ...
  'survey.strip_sub':       'Takes less than two minutes.',
  'survey.close':           'Close',
  'survey.thanks_title':    'Thank you for your evaluation',
  'survey.thanks_lede':     'Your answer was recorded anonymously.',
  'survey.continue':        'Continue to the trail',
  'survey.pres_label':      'Presentation',
  'survey.pres_dialog':     'Dialog',
  'survey.pres_full':       'Full screen',
  'survey.pace_label':      'Pace',
  'survey.pace_all':        'All at once',
  'survey.pace_steps':      'One at a time',
