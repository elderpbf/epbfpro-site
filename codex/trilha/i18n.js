...
const pt = {
  ...
  'login.validated_body':   'Você já pode voltar para a aba onde pediu acesso, ele já foi liberado lá.',
  'login.validated_cta':    'Acessar a trilha aqui',
...
const en = {
  ...
  'login.validated_body':   'You can go back to the tab where you asked for access, it is unlocked there.',
