...
const pt = {
  ...
  'wall.check_email_sub':   'Enviamos um link de acesso para {email}. Abra o e-mail e clique no link para entrar.',
  'wall.already_validated': 'Já validei',
  'wall.pending_approval_h': 'Aguardando aprovação',
  'wall.pending_approval_sub': 'Seu e-mail foi confirmado. Falta o instrutor liberar seu acesso, isso acontece em instantes. Esta página abre sozinha quando ele aprovar.',
  'wall.q_lead':            'Só quer',
...
const en = {
  ...
  'wall.check_email_sub':   'We sent an access link to {email}. Open the e-mail and tap the link to get in.',
  'wall.already_validated': 'I already validated',
  'wall.pending_approval_h': 'Waiting for approval',
  'wall.pending_approval_sub': 'Your e-mail is confirmed. The instructor just needs to grant your access, this happens shortly. This page opens on its own once they approve.',
