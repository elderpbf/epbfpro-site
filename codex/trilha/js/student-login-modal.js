...
export function openLoginModal(opts = {}) {
  ...
  function renderEnroll() {
    bodyEl.innerHTML =
      ...
      '<div class="tr-tarefa-actions">' +
        '<button type="button" class="tr-btn tr-btn-primary cdx-btn tr-en-join">' + esc(t('login.enroll_cta')) + '</button>' +
      '</div>';
  ...
  function renderEmail() {
    bodyEl.innerHTML =
      ...
      '<div class="tr-tarefa-error tr-login-error" aria-live="polite">' + esc(errorText(flow.error, flow.retryAfter)) + '</div>' +
      '<div class="tr-tarefa-actions">' +
        '<button type="button" class="tr-btn tr-btn-primary cdx-btn tr-login-send">' + esc(t('login.send_code')) + '</button>' +
      '</div>';
  ...
  function renderCode() {
    ...
    bodyEl.innerHTML =
      ...
      '<div class="tr-tarefa-error tr-login-error" aria-live="polite">' + esc(errorText(flow.error, flow.retryAfter)) + '</div>' +
      '<div class="tr-tarefa-actions">' +
        '<button type="button" class="tr-btn tr-btn-primary cdx-btn tr-login-verify">' + esc(t('login.verify')) + '</button>' +
        '<button type="button" class="tr-btn tr-btn-ghost cdx-btn tr-login-resend">' + esc(t('login.resend')) + '</button>' +
      '</div>';
  ...
  function renderProfile() {
    bodyEl.innerHTML =
      ...
      '<div class="tr-tarefa-error tr-login-error" aria-live="polite">' + esc(errorText(flow.error, flow.retryAfter)) + '</div>' +
      '<div class="tr-tarefa-actions">' +
        '<button type="button" class="tr-btn tr-btn-primary cdx-btn tr-login-finish">' + esc(t('login.finish')) + '</button>' +
      '</div>';
  ...
  function renderError() {
    bodyEl.innerHTML =
      ...
      '<div class="tr-tarefa-actions">' +
        '<button type="button" class="tr-btn tr-btn-primary cdx-btn tr-login-retry">' + esc(t('login.send_code')) + '</button>' +
      '</div>';
