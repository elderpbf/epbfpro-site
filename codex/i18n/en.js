...
export default {
  ...
  'cert.sub_emitidos':         'Issued',
  'cert.new_template':         '+ New template',
  'cert.new_default_title':    'New certificate template',
  'cert.empty_templates':      'No templates yet. Click "+ New template" to create one.',
  'cert.loading_templates':    'Loading templates...',
  'cert.error_loading':        'Error loading templates.',
  'cert.untitled':             '(untitled)',
  'cert.modified':             'Modified',
  'cert.delete':               'Delete',
  'cert.confirm_delete':       'Delete the template "{name}"? This action cannot be undone.',
  'cert.placeholder':          'Select a template from the sidebar, or create a new one.',
  // Token palette
  'cert.palette_title':        'Available variables',
  'cert.palette_hint':         'Click to copy. Paste into the slide text editor.',
  'cert.token_nome':           'Participant name',
  'cert.token_curso':          'Course name',
  'cert.token_carga':          'Course hours',
  'cert.token_data':           'Issue date',
  'cert.token_codigo':         'Certificate code',
  'cert.token_qr':             'Validation QR code',
  'cert.copied':               'Copied!'
};
