...
export default {
  ...
  'questions.host_ai_complex':           'Make more complex',
  'questions.comp_ai_complex_instr':     'IMPORTANT: raise the cognitive depth of this question while keeping the same topic and the same type. Replace the trivial prompt with an applied scenario/case that requires reasoning, analysis or judgement (not mere recall). Keep it clear and keep the number of options; make the distractors plausible and close to the correct answer, with no trick wording. Return the full, ready-to-use question.',
  'questions.comp_ai_four_options':      'For multiple-choice questions, provide exactly 4 options.',
