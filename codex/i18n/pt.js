...
export default {
  ...
  'questions.host_ai_complex':           'Tornar mais complexa',
  'questions.comp_ai_complex_instr':     'IMPORTANTE: aumente a profundidade cognitiva desta questão, mantendo o mesmo tema e o mesmo tipo. Substitua a pergunta trivial por um cenário/caso aplicado que exija raciocínio, análise ou julgamento (não apenas memorização). Mantenha a clareza e o número de alternativas; torne os distratores plausíveis e próximos da resposta correta, sem pegadinhas. Devolva a questão completa pronta para uso.',
  'questions.comp_ai_four_options':      'Para questões de múltipla escolha, forneça exatamente 4 alternativas.',
