...
export default {
  ...
  // #26 complexity review (reads existing questions, AI proposes harder variants)
  'questions.bank_complexify':        '↑ Mais complexas',
  'questions.bank_complexify_title':  'Versões mais complexas',
  'questions.bank_complexify_hint':   'Revise as variantes propostas. As aceitas viram questões NOVAS; as originais não mudam.',
  'questions.bank_complexify_generating': 'Gerando variantes mais complexas…',
  'questions.bank_complexify_empty':  'Este conjunto não tem questões para tornar mais complexas.',
  'questions.bank_complexify_error':  'Não consegui gerar as variantes.',
  'questions.bank_complexify_save':   'Salvar aceitas como novas',
  'questions.bank_cpx_original':      'Original',
  'questions.bank_cpx_proposed':      'Proposta (mais complexa)',
  // e2 propose order (AI suggests a warm-up → complex sequence, applied via reorder)
  'questions.bank_propose_order':     '↕ Propor ordem',
  'questions.bank_order_title':       'Ordem proposta',
  'questions.bank_order_hint':        'A IA sugeriu esta ordem (aquecimento → mais complexo). Aplicar reordena o banco.',
