...
export default {
  ...
  'alunos.direct_access':'Acesso direto, sem e-mail (sem confirmação por link)',
  ...
  'questions.display_qr_toggle':         'Inscrição por QR',
  ...
  'cert.sub_emitidos':         'Emitidos',
  'cert.new_template':         '+ Novo modelo',
  'cert.new_default_title':    'Novo modelo de certificado',
  'cert.empty_templates':      'Nenhum modelo cadastrado. Clique em "+ Novo modelo" para criar.',
  'cert.loading_templates':    'Carregando modelos...',
  'cert.error_loading':        'Erro ao carregar modelos.',
  'cert.untitled':             '(sem título)',
  'cert.modified':             'Modificado em',
  'cert.delete':               'Excluir',
  'cert.confirm_delete':       'Excluir o modelo "{name}"? Esta ação não pode ser desfeita.',
  'cert.placeholder':          'Selecione um modelo na barra lateral, ou crie um novo.',
  // Token palette
  'cert.palette_title':        'Variáveis disponíveis',
  'cert.palette_hint':         'Clique para copiar. Cole no editor de texto do slide.',
  'cert.token_nome':           'Nome do participante',
  'cert.token_curso':          'Nome do curso',
  'cert.token_carga':          'Carga horária',
  'cert.token_data':           'Data de emissão',
  'cert.token_codigo':         'Código do certificado',
  'cert.token_qr':             'QR code de validação',
  'cert.copied':               'Copiado!'
};
