...
export const TABS = [
  ...
  { key: 'alunos', labelKey: 'nav.alunos', href: '/codex/?tab=alunos',
    glyph: '<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><polyline points="16 11 18 13 22 9"></polyline>' }
];
