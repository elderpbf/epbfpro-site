...
(function() {
  ...
  // Bundle H: dropped the QR/ao-vivo pill icon and the /go/?code= header
  // link. Live questions now take over the trilha content area in place,
  // surfaced by trilha-nexo.js — no need for an opt-in header pill.
  ...
  // Bundle H: only WhatsApp is injected here. The "Perguntas ao vivo" pill
  // was dropped because live questions now take over the trilha content
  // area automatically (see trilha-nexo.js + nexo-answer.js).
