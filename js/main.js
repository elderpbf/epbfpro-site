...
import { apply } from './i18n.js?v=8';
import { initUI } from './ui.js?v=8';
import { initDemos } from './demos.js?v=8';
import { initOrb } from './orb.js?v=8';
import { initOrbSettings } from './orb-settings.js?v=8';
