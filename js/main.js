...
import { apply } from './i18n.js?v=10';
import { initUI } from './ui.js?v=10';
import { initDemos } from './demos.js?v=10';
import { initOrb } from './orb.js?v=10';
import { initOrbSettings } from './orb-settings.js?v=10';
