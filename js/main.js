...
import { apply } from './i18n.js?v=12';
import { initUI } from './ui.js?v=12';
import { initDemos } from './demos.js?v=12';
import { initOrb } from './orb.js?v=12';
import { initOrbSettings } from './orb-settings.js?v=12';
