...
const PULSO_SRCDOC =
  ...
  '</head><body><div id="cdx-tr-nexo-host"></div>' +
  '<script type="module" src="/js/frame-pulso.js?v=16"></scr' + 'ipt></body></html>';
...
const TRAIL_SRCDOC =
  ...
  '<div class="cdx-trilha-page" id="cdx-trilha-root">' +
    ...
    '</main>' +
  '</div>' +
  '<script type="module" src="/js/frame-trail.js?v=16"></scr' + 'ipt></body></html>';
